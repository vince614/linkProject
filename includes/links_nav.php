...
?>
<li id="<?=$l['code'] ?>" class="uk-parent">
    <a href="#"><span data-uk-icon="icon: link" class="uk-margin-small-right"></span><?=$l['title'] ?></a>
    <ul class="uk-subnav uk-flex uk-flex-center uk-child-width-1-4 uk-margin-small-top uk-margin-small-bottom" data-uk-grid>
        <li>
